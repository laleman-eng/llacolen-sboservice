Select DISTINCT spr.cardcode SocPrin, s.CardCode, s.LicTradNum, s.GroupCode, s.frozenFor, s.U_Ausente, spr.saldo, spr.DocDueDate  
,IsNull(U_SincPago, Convert(DateTime,'19000101',112))
  from OCRD s, 
       (select i.CardCode, i.DocTotal-i.PaidToDate as Saldo, i.DocDueDate, 
         ...
         where i.DocTotal = i.PaidToDate  
           ...
           and i.DocDueDate > IsNull(U_SincPago, Convert(DateTime,'19000101',112))  
           and c.GroupCode = 100 
