...
namespace Logs
{
   ...
   public class FileLog : Log
   {
      ...
      public FileLog()
      {
         this.FileName = "C:\\VID_SBOService.log";
         if (Llacolen_SBOService.Properties.Settings.Default.LogFile != "")
         {
             this.FileName = Llacolen_SBOService.Properties.Settings.Default.LogFile;
         }
      }
